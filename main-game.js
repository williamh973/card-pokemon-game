...
import { 
  displayFightInProgress, hideFightInProgress
} from './display-fight-in-progress.js';
import {
  weaknessFactorForFirstAttack,
} from './weakness-factor-first-attack.js';
import {
  weaknessFactorForSecondAttack,
} from './weakness-factor-second-attack.js';
import {
  resistanceFactorForFirstAttack,
} from './resistance-factor-first-attack.js';
import {
  resistanceFactorForSecondAttack,
} from './resistance-factor-second-attack.js';
import {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const selectFirstPokemonButton = document.getElementById('pokemonFirstSelection');
  
    const selectSecondPokemonButton = document.getElementById('pokemonSecondSelection');
    
    const pokemonFirstLocation = document.getElementById('pokemon-first-location');
    
    const pokemonSecondLocation = document.getElementById('pokemon-second-location');
  ...
  pokemonRandomSelectionButton.addEventListener('click', () => {
   ...
   containerFullPopupDialogueFight.style.display = 'none';
    ...
    const containerFullPopupDialogueFight = document.getElementById('container-display-dialogue');
