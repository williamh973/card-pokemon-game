...
function firstAttackerSecondaryStatutConfusingAlteration(
  firstAttacker
  ) {
...
function firstAttackerSecondaryStatutScaredAlteration(
  firstAttacker
  ) {
  ...
  function firstAttackerSecondaryStatutCursedAlteration(
    firstAttacker
    ) {
