...
function secondAttackerSecondaryStatutConfusingAlteration(
  secondAttacker
  ) {
...
function secondAttackerSecondaryStatutScaredAlteration(
  secondAttacker
  ) {
...
function secondAttackerSecondaryStatutCursedAlteration(
  secondAttacker
  ) {
