import { 
  secondAttackerPrimaryStatutAlteration,
} from "./second-attacker-statut-state-alteration/second-attacker-primary-statut-alteration.js";
  ...
  sleepStatutAlteredAnimation,
    ...
    if (
      ...
      secondAttacker.secondaryStatut.isNormal
          ...
          await sleepStatutAlteredAnimation(secondAttackerAlterationStateDelays.secondAttackerSecondStateConfusedDelay);
...
async function checkIfSecondAttackerStatusScared(
  ...
  sleepStatutAlteredAnimation,
    ...
    if (
      ...
      await sleepStatutAlteredAnimation(secondAttackerAlterationStateDelays.secondAttackerSecondStateScaredDelay);
    }
    ...
    if (
      ...
      secondAttacker.secondaryStatut.isNormal
        ...
        secondAttackerSecondaryStatutCursedAlteration(
          ...
          await sleepStatutAlteredAnimation(secondAttackerAlterationStateDelays.secondAttackerSecondStateCursedDelay);
